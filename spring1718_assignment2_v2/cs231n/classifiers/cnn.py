...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        conv_out, conv_cache = conv_relu_pool_forward(X, self.params['W1'],
                                                 self.params['b1'], conv_param, pool_param)
        hidden, hidden_cache = affine_relu_forward(conv_out, self.params['W2'],
                                                   self.params['b2'])
        scores, scores_cache = affine_forward(hidden, self.params['W3'], self.params['b3'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dconv_out, grads['W2'], grads['b2'] = affine_relu_backward(dhidden, hidden_cache)
